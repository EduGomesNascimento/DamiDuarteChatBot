...
const FRASES = [
  'Processando ideias em 168MHz.',
  'ARM. ESP. AVR. Entregue amanhã.',
  'Do bare metal ao FreeRTOS.',
    ...
    <section className="scanlines relative overflow-hidden border-b border-white/5">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:py-32">
        <span className="badge mb-6 inline-flex border border-primary/30 bg-primary/10 text-primary">
          ...
          Entrega expressa no RS
        </span>
        <h1 className="font-display text-4xl font-bold leading-tight sm:text-6xl">
          <span className="text-glow typing-cursor">{texto}</span>
        </h1>
        <p className="mt-6 max-w-2xl text-lg text-text-secondary">
          Microcontroladores, SBCs e componentes selecionados para quem leva projeto a sério —
          do estudante ao engenheiro. Specs honestas, suporte técnico de verdade.
        </p>
