...
const links = [
  ...
  { href: '/catalogo?categoria=st-arm', label: 'ST/ARM' },
  { href: '/catalogo?categoria=esp-wifi', label: 'ESP/WiFi' },
  { href: '/catalogo?categoria=arduino-avr', label: 'Arduino' },
  { href: '/catalogo?categoria=raspberry-pi', label: 'Raspberry Pi' },
]
